...
def rotate_box_dot(x_cen, y_cen, width, height, theta):
    ...
    rotated_x2, rotated_y2 = rotate(
        (x_cen, y_cen), (x_min, y_min+height), theta)
    rotated_x3, rotated_y3 = rotate(
        (x_cen, y_cen), (x_min+width, y_min+height), theta)
    rotated_x4, rotated_y4 = rotate(
        (x_cen, y_cen), (x_min+width, y_min), theta)

    return [rotated_x1, rotated_y1, rotated_x2, rotated_y2, rotated_x3, rotated_y3, rotated_x4, rotated_y4]


print(rotate_box_dot(1059.68380,  535.97925,  158.898560,  449.85040,  1.085560))

origin = 0, 0
point = 1059.68380,  535.97925
radian = 1.085560

print(rotate(origin, point, radian))
